...
namespace PieceRatePay
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double averageHourlyPay = Convert.ToDouble(salary / hours);
            ...
            Console.WriteLine($"You worked {hours} and were parid a salary of {salary}, your average hourly pay is " + String.Format("{0:C}",averageHourlyPay));
        }
    }
}